...
export const HOME_FEATURES: FeatureButtonConfig[] = [
  ...
  { key: "home-trading-hall", label: "交易大厅", subtitle: "交易大厅", image: tradingHallIllustration, path: "/code-market" },
...
export const TEXT = {
  home: {
    ...
    signInRules: [
      ...
      "· 当日签到成功后，奖励将于次日到账",
      "· 若中途未签到，P币会从次日起按断签天数递减：断1天减10，断2天减20，断3天及以上每天减40，直至余额为0，建议保持每日签到",
    ],
  },
  donor: {
    title: "东家打赏",
